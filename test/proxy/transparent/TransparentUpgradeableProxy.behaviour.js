...
module.exports = function shouldBehaveLikeTransparentUpgradeableProxy() {
  if (network.name === 'hardhat') {
    before(async function () {
      const implementationV0 = await deployFBContract('DummyImplementation');
      const implementationV1 = await deployFBContract('DummyImplementation');
    ...
    describe('upgradeToAndCall', function () {
      describe('without migrations', function () {
        beforeEach(async function () {
          this.behavior = await deployFBContract('InitializableMock');
        });
      ...
      describe('with migrations', function () {
        describe('when the sender is the admin', function () {
          ...
          describe('when upgrading to V1', function () {
            beforeEach(async function () {
              this.behaviorV1 = await deployFBContract('MigratableMockV1');
            ...
            describe('when upgrading to V2', function () {
              beforeEach(async function () {
                this.behaviorV2 = await deployFBContract('MigratableMockV2');
              ...
              describe('when upgrading to V3', function () {
                beforeEach(async function () {
                  this.behaviorV3 = await deployFBContract('MigratableMockV3');
        ...
        describe('when the sender is not the admin', function () {
          it('reverts', async function () {
            const behaviorV1 = await deployFBContract('MigratableMockV1');
    ...
    describe('transparent proxy', function () {
      beforeEach('creating proxy', async function () {
        this.clashingImplV0 = await deployFBContract('ClashingImplementation');
        this.clashingImplV1 = await deployFBContract('ClashingImplementation');
    ...
    describe('regression', function () {
      ...
      it('should add new function', async function () {
        const impl1 = await deployFBContract('Implementation1');
        const impl2 = await deployFBContract('Implementation2');
      ...
      it('should change function signature', async function () {
        const impl1 = await deployFBContract('Implementation1');
        const impl3 = await deployFBContract('Implementation3');
        const { instance, proxy, proxyAdminAsSigner } = await this.createProxyWithImpersonatedProxyAdmin(
          impl1,
          initializeData,
        );
      ...
      it('should add fallback function', async function () {
        const impl1 = await deployFBContract('Implementation1');
        const impl4 = await deployFBContract('Implementation4');
        const { instance, proxy, proxyAdminAsSigner } = await this.createProxyWithImpersonatedProxyAdmin(
          impl1,
          initializeData,
        );
