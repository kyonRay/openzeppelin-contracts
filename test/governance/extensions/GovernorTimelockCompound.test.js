  ...
  describe('GovernorTimelockCompound', function () {
    for (const { Token, mode } of TOKENS) {
      const fixture = async () => {
        ...
        const timelock = await deployFBContract('CompTimelock', [predictGovernor, defaultDelay]);
        const mock = await deployFBContract('$GovernorTimelockCompoundMock', [
          name,
          votingDelay,
          votingPeriod,
          0n,
      ...
      describe(`using ${Token}`, function () {
        ...
        describe('should revert', function () {
          ...
          describe('on safe receive', function () {
            describe('ERC721', function () {
              ...
              beforeEach(async function () {
                this.token = await deployFBContract('$ERC721', ['Non Fungible Token', 'NFT']);
            ...
            describe('ERC1155', function () {
              ...
              beforeEach(async function () {
                this.token = await deployFBContract('$ERC1155', ['https://token-cdn-domain/{id}.json']);
        ...
        describe('onlyGovernance', function () {
          ...
          describe('updateTimelock', function () {
            beforeEach(async function () {
              this.newTimelock = await deployFBContract('CompTimelock', [this.mock, time.duration.days(7n)]);
            });
          ...
          it('can transfer timelock to new governor', async function () {
            const newGovernor = await deployFBContract('$GovernorTimelockCompoundMock', [
              name,
              8n,
              32n,
              0n,
